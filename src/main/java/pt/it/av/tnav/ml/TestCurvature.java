...
public class TestCurvature {
  ...
  public static <D extends Distance<D>> void elbowTest(List<String> header, List<Curvature> curv, final List<D> dps,
  ...
  public static <D extends Distance<D>> void dbscanElbowTest(final List<D> dps, final int min, final int max) {
